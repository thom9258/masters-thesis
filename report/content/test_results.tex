...
Furthermore, the second software was designed to remove, merge and sub-sample 3D marker output files from Motive \cite{motive}.
...
In order to determine what types of filters have a positive effect on the \gls{sEMG} data recorded using the Motive motion capture system \cite{motive}, different types of state-of-the-art pre-processing filters were tested and compared.
