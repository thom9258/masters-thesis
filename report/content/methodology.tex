...
An example of flexion with the capture glove can be seen in figure \ref{fig:minbend} \& \ref{fig:maxbend}.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{minimum bend of the glove.}
        \label{fig:minbend}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Maximum bend of the glove.}
        \label{fig:maxbend}
    \end{subfigure}
    \caption{Design and purpose of the created 3D marker capture glove.}
\end{figure}
...
The model is implemented in Coppeliasim \cite{coppeliasim}, and can be seen in figure  \ref{fig:simdesignandimpl}, The model is created in a hierachy, the bones are created with cylinders and the joints are created using 1 DoF Revolute joints.
% Ref coppeliasim
